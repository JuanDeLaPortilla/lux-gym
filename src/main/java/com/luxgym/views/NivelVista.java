...
import com.luxgym.controllers.NivelControlador;
...
public class NivelVista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableNivel = new javax.swing.JTable();
        ...
        favicon.setText("Panel de Niveles");
        ...
        txtIdNivel.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        txtIdNivel.setForeground(new java.awt.Color(0, 0, 0));
        txtIdNivel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtIdNivel.setCaretColor(new java.awt.Color(0, 51, 204));
        txtIdNivel.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                txtIdNivelMousePressed(evt);
            }
        });
        ...
        bg.add(txtIdNivel, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 130, 270, 30));
        ...
        tableNivel.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tableNivel);
        if (tableNivel.getColumnModel().getColumnCount() > 0) {
            tableNivel.getColumnModel().getColumn(0).setResizable(false);
            tableNivel.getColumnModel().getColumn(1).setResizable(false);
    ...
    private void txtIdNivelMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtIdNivelMousePressed

    }//GEN-LAST:event_txtIdNivelMousePressed
    ...
    public static void main(String args[]) throws SQLException, ClassNotFoundException {
        NivelVista vista = new NivelVista();
        NivelControlador controlador = new NivelControlador(vista);
    ...
    public javax.swing.JTable tableNivel;
    public javax.swing.JTextField txtDescripcion;
    public javax.swing.JTextField txtIdNivel;
