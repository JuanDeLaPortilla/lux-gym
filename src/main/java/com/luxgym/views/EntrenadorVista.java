...
import com.luxgym.controllers.EntrenadorControlador;
...
public class EntrenadorVista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        iddocente3 = new javax.swing.JLabel();
        ...
        favicon.setText("Panel de Entrenadores");
        bg.add(favicon, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 60, -1, -1));
        ...
        bg.add(favicon1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, -1, -1));
        ...
        iddocente.setText("ID Entrenador");
        ...
        txtIdEntrenador.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        txtIdEntrenador.setForeground(new java.awt.Color(0, 0, 0));
        txtIdEntrenador.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtIdEntrenador.setCaretColor(new java.awt.Color(0, 51, 204));
        txtIdEntrenador.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                txtIdEntrenadorMousePressed(evt);
            }
        });
        txtIdEntrenador.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtIdEntrenadorActionPerformed(evt);
            }
        });
        bg.add(txtIdEntrenador, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 130, 270, 30));
        ...
        if (tableEntrenador.getColumnModel().getColumnCount() > 0) {
            tableEntrenador.getColumnModel().getColumn(0).setPreferredWidth(60);
            tableEntrenador.getColumnModel().getColumn(0).setMaxWidth(60);
            tableEntrenador.getColumnModel().getColumn(3).setPreferredWidth(80);
            tableEntrenador.getColumnModel().getColumn(3).setMaxWidth(80);
            tableEntrenador.getColumnModel().getColumn(4).setPreferredWidth(60);
            tableEntrenador.getColumnModel().getColumn(4).setMaxWidth(60);
            tableEntrenador.getColumnModel().getColumn(5).setPreferredWidth(130);
            tableEntrenador.getColumnModel().getColumn(5).setMaxWidth(130);
        }
        ...
        bg.add(panel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 180, -1, -1));
        ...
        bg.add(panel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 320, -1, -1));

        jComboBoxEspecialidad.setForeground(new java.awt.Color(0, 0, 0));
        jComboBoxEspecialidad.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxEspecialidadActionPerformed(evt);
            }
        });
        bg.add(jComboBoxEspecialidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 270, 270, 30));

        panel3.setBackground(new java.awt.Color(204, 255, 255));
        panel3.setBorder(new javax.swing.border.MatteBorder(null));

        iddocente3.setBackground(new java.awt.Color(255, 204, 255));
        iddocente3.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        iddocente3.setForeground(new java.awt.Color(0, 0, 153));
        iddocente3.setText("Especialidad");
        ...
        bg.add(panel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 250, -1, -1));
        ...
        bg.add(jComboBoxHorario, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 340, 270, 30));
        ...
        bg.add(jComboBoxUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 200, 270, 30));
    ...
    private void txtIdEntrenadorMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtIdEntrenadorMousePressed

    }//GEN-LAST:event_txtIdEntrenadorMousePressed

    private void txtIdEntrenadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtIdEntrenadorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtIdEntrenadorActionPerformed
    ...
    public static void main(String args[]) throws SQLException, ClassNotFoundException {
        EntrenadorVista vista = new EntrenadorVista();
        EntrenadorControlador controlador = new EntrenadorControlador(vista);
    ...
    private javax.swing.JLabel iddocente3;
